...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xime0sq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xime0sq.containers.anotherwebservice.com/
...
```
git clone git@github.com:bahadur21656/container-xime0sq.git
cd container-xime0sq
```
...
```
docker attach container-xime0sq
```
